...
log "In: S{BASH_SOURCE} ${FUNCNAME[0]}"
psql -At -U $PGUSER -h $PGHOST -p $PGPORT -d $DATABASE -c "INSERT INTO xdruple.xd_site(xd_site_name, xd_site_url, xd_site_notes) SELECT 'demo495_ecommerce','http://shop.prodiem.xd','ecomm site'; \
